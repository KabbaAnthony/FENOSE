...
// User is logged in, fetch their account information from the database using the user_id in the session
$host = 'localhost';
$user = 'root';
$password = '';
$database = 'fenose';
...
// Prepare and execute the query to fetch the user's account information
...
if ($result->num_rows == 1) {
    // User found, display their account information
    ...
    // You can include other account-related actions or information here
} else {
    // Error retrieving user's account information
                    ...
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                ...
                                <li><a href="locations.php"><i class="icon-placeholder"></i> 15/A, Nest Tower, NYC</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                                ...
                                <div class="col-lg-4">
                                    <div class="ltn__tab-menu-list mb-50">
                                        <div class="nav">                                            
                                            ...
                                            <a href="logout.php" onclick="return confirm('Are you sure you want to log out?')">Logout <i class="fas fa-sign-out-alt"></i></a>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="ltn_tab_1_1">
                                            <div class="ltn__myaccount-tab-content-inner">
                                                ...
                                                <p>Hello <strong><?php echo "Welcome, $username!<br>";?></strong>
                                                <p>Your User Email: <?php echo $email; ?></p>
